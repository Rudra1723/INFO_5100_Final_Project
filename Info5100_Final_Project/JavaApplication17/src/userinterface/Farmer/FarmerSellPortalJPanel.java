...
public class FarmerSellPortalJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnSubmitCrop.setBackground(new java.awt.Color(0, 153, 102));
        btnSubmitCrop.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel5.setText("Farmer Sell Portal");
        ...
        crop.setExpiryDate(expDate);
         ...
         Organization org = null;
            ...
            if(expDate.after(new Date())){
                ...
                // Save to database to persist the crop listing
                try {
                    Business.DB4OUtil.DB4OUtil.getInstance().storeSystem(business);
                    JOptionPane.showMessageDialog(null, "Crop added successfully!");
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(null, "Warning: Crop added but there was an issue saving to database: " + e.getMessage());
                }
